...
:1
  ...
  tshark  -i 1 > %SUBFILENAME%

  ::"C:\Users\DaVinci\wireshark_logs\%date%-%time%.log"
...
:file_namer
  ...
  set SUBFILENAME=C:\Users\DaVinci\wireshark_logs\virtualnetwrok_%CUR_YYYY%%boob%%CUR_MM%%boob%%CUR_DD%_%CUR_HH%%tit%%CUR_NN%%tit%%CUR_SS%

  ::echo "Welcome Here!" >
  echo "CALL :1" > %SUBFILENAME%.log
